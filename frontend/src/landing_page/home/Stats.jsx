        ...
        <div className='container p-3'>
            <div className='row p-3' >
                <div className='col-6 p-5'>
                    ...
                    <p className='text-muted'>That's why 1.6+ crore customers trust Zerodha with ~ ₹6 lakh crores of equity investments.</p>
                ...
                <div className='col-6 p-3 mt-5'>
                    <img src="media/images/ecosystem.png" style={{width: "100%"}} alt="Ecosystem Image" />
                    <div>
